...
# i.e., https://colab.research.google.com/github/j3soon/colab-python-version/blob/main/notebooks/py311.ipynb
# For more information, see: https://github.com/j3soon/colab-python-version.

wget -O miniconda.sh https://repo.anaconda.com/miniconda/Miniconda3-py311_25.1.1-2-Linux-x86_64.sh
